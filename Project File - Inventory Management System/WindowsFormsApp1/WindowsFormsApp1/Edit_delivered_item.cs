...
namespace WindowsFormsApp1
{
    public partial class Edit_delivered_item :Form
    {
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into DILIVERITEM values ('" + itemname.Text + "','" + societyname.Text + "'," + noof.Text + "," + Societycode.Text + "," + itemid.Text + ")";
            cmd.Connection = con;
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        {
            this.Hide();
            Delivered_item rt = new Delivered_item();
            rt.Show();
        }
    }
}
